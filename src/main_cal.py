...
class Adsorption:
    ...
    def initial_ph(self, eq_phase):
        ...
        res = get_pH(prc.get_selected_output_array())
...
def run_phreeqc(titration: Adsorption):
    ...
    sel_output = prc.get_selected_output_array()
    res = get_pH(sel_output)
    prc.destroy_iphreeqc()
    return res
