...
public:
	...
	int numerical_jacobian(const std::vector<int> *column_colors = NULL,
		const std::vector<std::vector<bool> > *jacobian_support = NULL);
	bool build_cd_music_local_analytic_columns(
